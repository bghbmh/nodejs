...
class ModalPopup extends HTMLElement {
	...
	constructor() {
		...
		const templateHTML = `
		<div class="modal-dialog " part="modal-dialog">
			...
			<div class="modal-content" part="content" role="dialog" aria-modal="true">
				...
				<button type="button" 
						...
						aria-label="팝업 닫기 버튼"></button>

				<header class="modal-header" part="modal-header">
					<slot name="modal-header"></slot>
				</header>
				<main class="modal-body" part="modal-body">
					<slot></slot>
				</main>
	...
	connectedCallback() { console.log("connectedCallback called! ///////////// ", this.shadowRoot.host)
		...
		this.content.classList.add( `size-${this.getAttribute("size") || 'default'}` )
